...
public class DispatcherGenerator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileWriter fw = new FileWriter("src/main/java/org/ngscript/vm/cpu/AutoCreatedCpuDispatcher.java");
        ...
        fw.write("import static org.ngscript.common.OpCode.*;");
        ...
        for (Method m : methods) {
            ...
            if (cls.length > 0 && cls[0] == WscVM.class) {
                ...
                fw.write("case " + name.toUpperCase() + ":");
